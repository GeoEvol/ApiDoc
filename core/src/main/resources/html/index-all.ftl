...
<head>
    ...
    <title>Index - ${data.projectName}</title>
    ...
    <aside class="docs-sidebar">
        <div class="docs-sidebar-inner" data-docs-sidebar data-nav-open="true">
            ...
            <nav class="docs-sidebar-nav">
                ...
                <a class="active" href="index-all.html">Index</a>
    ...
    <main class="docs-content">
        <header class="docs-topbar">
            <div class="docs-headline">
                <div class="breadcrumb">Overview / Index</div>
                <h1>Index</h1>
            </div>
        ...
        <section class="section-card">
            <h2>Types</h2>
            <div class="type-list">
            <#list data.apiDocs?sort_by("name") as doc>
                <a href="${doc.path}" class="type-row"><span>${doc.name}</span><small>${doc.packageName!''}</small></a>
            </#list>
            </div>
        </section>
    </main>
