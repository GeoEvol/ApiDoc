...
class ReferenceResolverTest {
    ...
    @Test
    void resolvesInternalTypesAndLeavesExternalTypesUnresolvedByDefault() {
    ...
    @Test
    void canResolveExternalTypesWhenConfiguredWithExternalLinkResolver() {
        DocCorpus corpus = sampleCorpus()

        new ReferenceResolver(new ExternalLinkResolver()).resolve(corpus)
