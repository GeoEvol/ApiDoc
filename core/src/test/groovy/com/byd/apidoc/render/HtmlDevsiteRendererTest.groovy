...
class HtmlDevsiteRendererTest {
    ...
    void rendersDevsiteInspiredStaticTypePageShellFromProjection() {
        ...
        assertTrue(text.indexOf("ad-search-wrap ad-nav-search-wrap") < text.indexOf("ad-platform-selector"))
        ...
        assertTrue(text.contains("class=\"ad-book-nav-restore-handle\""))
        assertFalse(text.contains("class=\"ad-book-nav-restore\""))
        ...
        assertTrue(text.contains("Packages Index"))
        assertTrue(text.contains("Classes Index"))
        ...
        assertTrue(css.text.contains(".ad-book-nav-restore-handle"))
        assertFalse(css.text.contains(".ad-book-nav-restore {"))
        assertFalse(css.text.contains("--ad-left-nav-width: 48px"))
        assertFalse(css.text.contains("translateX(calc(-1 * var(--ad-left-nav-width)))"))
        assertTrue(css.text.contains("body.ad-nav-collapsed .ad-book-nav-scroll"))
        assertTrue(css.text.contains("body.ad-nav-collapsed .ad-book-nav-footer"))
        assertTrue(css.text.contains("visibility: hidden"))
        ...
        assertFalse(js.text.contains("ad-book-nav-restore\""))
        assertFalse(js.text.contains("restoreToggle"))
        assertTrue(js.text.contains("restoreHandle"))
        assertTrue(js.text.contains("ad-book-nav-restore-handle"))
        ...
        assertFalse(js.text.contains("ad-nav-filter"))
        assertFalse(js.text.contains("setPlatformHidden"))
        assertFalse(js.text.contains("applyNavFilter"))
        assertFalse(js.text.contains("ad-platform-hidden"))
        assertFalse(js.text.contains("pkg.hidden ="))
        assertFalse(js.text.contains("group.hidden ="))
        assertFalse(js.text.contains("link.hidden ="))
        ...
        assertTrue(classesText.contains("<h1>Classes Index</h1>"))
        ...
        assertTrue(packagesText.contains("<h1>Packages Index</h1>"))
